...
contract NounsClientTokenDescriptor is INounsClientTokenDescriptor {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    '<text fill="black" fill-opacity="0.5" xml:space="preserve" style="white-space: pre" font-family="Courier" font-size="15" letter-spacing="0em"><tspan x="30" y="267.433">Client URL:</tspan></text>',
                    '<text fill="black" xml:space="preserve" style="white-space: pre" font-family="Courier" font-size="15" letter-spacing="0em"><tspan x="30" y="286.433">',
                    metadata.description,
                    '</tspan></text>',
                    '<text fill="black" fill-opacity="0.5" xml:space="preserve" style="white-space: pre" font-family="Courier" font-size="15" letter-spacing="0em"><tspan x="30" y="211.433">Client ID:</tspan></text>',
                    '<text fill="black" xml:space="preserve" style="white-space: pre" font-family="Courier" font-size="15" letter-spacing="0em"><tspan x="30" y="230.433">',
                    tokenId.toString(),
                    '</tspan></text>',
                    '<text fill="black" fill-opacity="0.5" xml:space="preserve" style="white-space: pre" font-family="Courier" font-size="15" letter-spacing="0em"><tspan x="30" y="155.433">Total rewarded:</tspan></text>',
                    '<text fill="black" xml:space="preserve" style="white-space: pre" font-family="Courier" font-size="15" letter-spacing="0em"><tspan x="30" y="174.433">',
                    metadata.rewarded.toETHString(),
                    ' ETH</tspan></text>',
                    '<text fill="black" fill-opacity="0.5" xml:space="preserve" style="white-space: pre" font-family="Courier" font-size="15" letter-spacing="0em"><tspan x="30" y="99.4329">Status:</tspan></text>',
                    '<text fill="black" xml:space="preserve" style="white-space: pre" font-family="Courier" font-size="15" letter-spacing="0em"><tspan x="30" y="118.433">',
                    metadata.approved ? 'Approved' : 'Not Approved',
                    '</tspan></text>'
                    '<text fill="black" fill-opacity="0.5" xml:space="preserve" style="white-space: pre" font-family="Courier" font-size="15" letter-spacing="0em"><tspan x="30" y="43.4329">Client Name:</tspan></text>',
                    '<text fill="black" xml:space="preserve" style="white-space: pre" font-family="Courier" font-size="15" letter-spacing="0em"><tspan x="30" y="62.4329">',
                    metadata.name,
                    '</tspan></text>'
                )
            );
