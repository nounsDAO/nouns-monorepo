 ...
 * the owner.
 */
contract OwnableWP is ContextWP {
 ...
 */
contract PausableWP is ContextWP {
 ...
 */
contract ERC165WP is IERC165WP {
 ...
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract ERC721WP is ContextWP, ERC165WP, IERC721WP {

    using SafeMathWP for uint256;
    using AddressWP for address;
    using CountersWP for CountersWP.Counter;
    ...
    mapping (address => CountersWP.Counter) private _ownedTokensCount;
    ...
    function _checkOnERC721Received(address from, address to, uint256 tokenId, bytes memory _data) internal returns (bool) {
        ...
        (bool success, bytes memory returndata) = to.call(abi.encodeWithSelector(
            IERC721ReceiverWP(to).onERC721Received.selector,
            _msgSender(),
            from,
            tokenId,
            _data
 ...
 * @dev See https://eips.ethereum.org/EIPS/eip-721
 */
contract ERC721EnumerableWP is ERC721WP, IERC721EnumerableWP {
...
contract ERC721MetadataWP is ERC721WP, IERC721MetadataWP {

    using StringsWP for uint256;
 ...
 */
contract ERC721FullWP is ERC721EnumerableWP, ERC721MetadataWP {

    constructor (string memory name, string memory symbol) public ERC721MetadataWP(name, symbol) {
        // solhint-disable-previous-line no-empty-blocks
    }
...
contract WrappedPunk is OwnableWP, ERC721FullWP, PausableWP {

    event ProxyRegistered(address user, address proxy);

    // Instance of cryptopunk smart contract
    ICryptoPunkWP private _punkContract;
    ...
    constructor(address punkContract)
        public
        ERC721FullWP("Wrapped Cryptopunks", "WPUNKS")
    {
        _punkContract = ICryptoPunkWP(punkContract);
    }
        ...
        public
    {
        ...
        address proxy = address(new UserProxyWP());
        ...
        whenNotPaused
    {
        ...
        UserProxyWP proxy = UserProxyWP(_proxies[sender]);
