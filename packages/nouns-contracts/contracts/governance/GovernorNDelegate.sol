...
contract GovernorNDelegate is GovernorNDelegateStorageV1, GovernorNEvents {
    ...
    function initialize(
        ...
        require(
            ...
            'GovernorN::initialize: invalid voting period'
        );
        require(
            votingDelay_ >= MIN_VOTING_DELAY && votingDelay_ <= MAX_VOTING_DELAY,
            'GovernorN::initialize: invalid voting delay'
        );
        require(
            proposalThresholdBPS_ >= MIN_PROPOSAL_THRESHOLD_BPS && proposalThresholdBPS_ <= MAX_PROPOSAL_THRESHOLD_BPS,
            'GovernorN::initialize: invalid proposal threshold'
        );
        require(
    ...
    function propose(
        ...
        require(
            ...
            'GovernorN::propose: proposer votes below proposal threshold'
        );
        require(
            targets.length == values.length &&
                targets.length == signatures.length &&
                targets.length == calldatas.length,
            'GovernorN::propose: proposal function information arity mismatch'
        );
        ...
        if (temp.latestProposalId != 0) {
            ...
            require(
                ...
                'GovernorN::propose: one live proposal per proposer, found an already active proposal'
            );
            require(
                proposersLatestProposalState != ProposalState.Pending,
                'GovernorN::propose: one live proposal per proposer, found an already pending proposal'
            );
        }
    ...
    function queue(uint256 proposalId) external {
        require(
            ...
            'GovernorN::queue: proposal can only be queued if it is succeeded'
        );
    ...
    function queueOrRevertInternal(
        ...
        require(
            ...
            'GovernorN::queueOrRevertInternal: identical proposal action already queued at eta'
        );
    ...
    function execute(uint256 proposalId) external {
        require(
            ...
            'GovernorN::execute: proposal can only be executed if it is queued'
        );
        Proposal storage proposal = proposals[proposalId];
    ...
    function cancel(uint256 proposalId) external {
        ...
        require(
            ...
            'GovernorN::cancel: proposer above threshold'
        );
    ...
    function _setVotingDelay(uint256 newVotingDelay) external {
        ...
        require(
            ...
            'GovernorN::_setVotingDelay: invalid voting delay'
        );
    ...
    function _setVotingPeriod(uint256 newVotingPeriod) external {
        ...
        require(
            ...
            'GovernorN::_setVotingPeriod: invalid voting period'
        );
    ...
    function _setProposalThresholdBPS(uint256 newProposalThresholdBPS) external {
        ...
        require(
            ...
            'GovernorN::_setProposalThreshold: invalid proposal threshold'
        );
