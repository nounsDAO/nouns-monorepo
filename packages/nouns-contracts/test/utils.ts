...
export const deployTokenDescriptor = async (
  deployer?: SignerWithAddress,
  ...
  const nounsDescriptorFactory = new TokenDescriptorFactory(
...
export const populateDescriptor = async (nounsDescriptor: TokenDescriptor): Promise<void> => {
 ...
 */
export const setTotalSupply = async (token: TellerToken, newTotalSupply: number): Promise<void> => {
