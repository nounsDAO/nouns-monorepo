...
abstract contract NounsDAOLogicV1V2StateTest is NounsDAOLogicSharedBaseTest {
    ...
    function testActiveGivenProposalPastVotingDelay() public {
        ...
        assertTrue(daoProxy.state(proposalId) == uint256(NounsDAOStorageV1.ProposalState.Active));
    }
    ...
    function testCanceledGivenCanceledProposal() public {
        ...
        assertTrue(daoProxy.state(proposalId) == uint256(NounsDAOStorageV1.ProposalState.Canceled));
    }
    ...
    function testDefeatedByRunningOutOfTime() public {
        ...
        assertTrue(daoProxy.state(proposalId) == uint256(NounsDAOStorageV1.ProposalState.Defeated));
    }
    ...
    function testSucceeded() public {
        ...
        assertTrue(daoProxy.state(proposalId) == uint256(NounsDAOStorageV1.ProposalState.Succeeded));
    }
    ...
    function testQueued() public {
        ...
        assertTrue(daoProxy.state(proposalId) == uint256(NounsDAOStorageV1.ProposalState.Queued));
    }
    ...
    function testExpired() public {
        ...
        assertTrue(daoProxy.state(proposalId) == uint256(NounsDAOStorageV1.ProposalState.Expired));
    }
    ...
    function testExecutedOnlyAfterQueued() public {
        ...
        assertTrue(daoProxy.state(proposalId) == uint256(NounsDAOStorageV1.ProposalState.Executed));
