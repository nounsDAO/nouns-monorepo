...
contract DescriptorUpgradeToV3 is Test, DeployUtils {
    NounsToken nounsToken;
    address minter = address(2);
    NounsDescriptorV2 descriptorV2;
    NounsDescriptorV3 descriptorV3;
    ...
    function setUp() public {
        ...
        nounsToken = new NounsToken(noundersDAO, minter, descriptorV2, new NounsSeeder(), proxyRegistry);

        descriptorV3 = _deployAndPopulateV3();
    }

    function testUpgradeToV3MaintainsTokenURI() public {
        ...
        for (uint256 i = 0; i < tokensToMint; i++) {
            ...
            if (
                ...
                // these images were fixed prior to v3 deployment so not comparing these
                continue;
            }
            ...
            nounsToken.setDescriptor(descriptorV3);
            string memory tokenURIwithV3 = nounsToken.tokenURI(i);

            assertEq(tokenURIwithV3, tokenURIwithV2);
        }
    }
    ...
    function ignore_testSaveHtmlFileWithSvgs() public {
        NounsDescriptorV3 d = _deployAndPopulateV3();
