...
contract NounsBRArtTest is Test, DescriptorHelpers {
    ...
    function setUp() public {
        ...
        art = new NounsBRArt(descriptor, inflator);
    }
    ...
    function testSetDescriptorRevertsIfSenderNotDescriptor() public {
        vm.expectRevert(INounsBRArt.SenderIsNotDescriptor.selector);
    ...
    function testPalettesRevertsGivenNoArt() public {
        vm.expectRevert(INounsBRArt.PaletteNotFound.selector);
        art.palettes(0);
    }
    ...
    function testCannotSetEmptyPalette() public {
        vm.prank(descriptor);
        vm.expectRevert(INounsBRArt.EmptyPalette.selector);
    ...
    function testCannotSetPaletteWithLengthNotAMultipleOf3() public {
        ...
        vm.expectRevert(INounsBRArt.BadPaletteLength.selector);
    ...
    function testBodiesRevertsGivenNoArt() public {
        vm.expectRevert(INounsBRArt.ImageNotFound.selector);
        art.bodies(0);
    }
