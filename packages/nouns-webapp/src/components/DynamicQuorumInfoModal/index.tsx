...
import { Proposal, useMaxQuorumVotesBPS, useMinQuorumVotesBPS, useQuorumLinearCoefficent, useQuorumQuadraticCoefficient, useQuorumVotesBPSOffset } from "../../wrappers/nounsDao";
