...
const Documentation = () => {
  const cryptopunksLink = (
    <Link text={<Trans>Cryptopunks</Trans>} url="https://www.larvalabs.com/cryptopunks" leavesPage={true} />
  );
  const playgroundLink = <Link text={<Trans>Playground</Trans>} url="/playground" leavesPage={false} />;
  ...
  const compoundGovLink = (
    <Link text={<Trans>Compound Governance</Trans>} url="https://compound.finance/governance" leavesPage={true} />
  );
  return (
      ...
      <Col lg={{ span: 10, offset: 1 }}>
        ...
        <Accordion flush>
          <Accordion.Item eventKey="0" className={classes.accordionItem}>
            <Accordion.Header className={classes.accordionHeader}><Trans>Summary</Trans></Accordion.Header>
            <Accordion.Body>
              <ul>
                <li><Trans>Nouns artwork is in the {publicDomainLink}.</Trans></li>
                <li><Trans>One Noun is trustlessly auctioned every 24 hours, forever.</Trans></li>
                <li><Trans>100% of Noun auction proceeds are trustlessly sent to the treasury.</Trans></li>
                <li><Trans>Settlement of one auction kicks off the next.</Trans></li>
                <li><Trans>All Nouns are members of Nouns DAO.</Trans></li>
                <li><Trans>Nouns DAO uses a fork of {compoundGovLink}.</Trans></li>
                <li><Trans>One Noun is equal to one vote.</Trans></li>
                <li><Trans>The treasury is controlled exclusively by Nouns via governance.</Trans></li>
                <li><Trans>Artwork is generative and stored directly on-chain (not IPFS).</Trans></li>
                <li><Trans>No explicit rules exist for attribute scarcity; all Nouns are equally rare.</Trans></li>
                <li><Trans>
          ...
          <Accordion.Item eventKey="1" className={classes.accordionItem}>
            ...
            <Accordion.Body>
              <p className={classes.aboutText}><Trans>
          ...
          <Accordion.Item eventKey="2" className={classes.accordionItem}>
            <Accordion.Header className={classes.accordionHeader}><Trans>Nouns DAO</Trans></Accordion.Header>
            <Accordion.Body>
              <Trans>
          ...
          <Accordion.Item eventKey="4" className={classes.accordionItem}>
            ...
            <Accordion.Body>
              ...
              <ul>
                <li><Trans>backgrounds (2) </Trans></li>
                <li><Trans>bodies (30)</Trans></li>
                <li><Trans>accessories (137) </Trans></li>
                <li><Trans>heads (234) </Trans></li>
                <li><Trans>glasses (21)</Trans></li>
              </ul>
              <Trans>
