...
const AuctionTimer: React.FC<AuctionTimerProps> = ({ auction, auctionEnded }) => {
  ...
  return (
    <div
      className="max-lg:mx-0 max-lg:w-auto max-lg:pl-0 max-lg:justify-between mt-0.3 flex w-max cursor-pointer flex-wrap pl-10 pr-0"
      onClick={() => setTimerToggle(!timerToggle)}
    >
      <div className="max-lg:mt-0 max-lg:pl-2 mt-px">
        <h4
      ...
      <div>
        {timerToggle ? (
          <h2
            className="font-pt max-lg:text-23 max-lg:pr-2 text-32 mb-0 mt-px flex font-bold"
            style={{
              color: isCool ? 'var(--brand-cool-dark-text)' : 'var(--brand-warm-dark-text)',
            }}
          >
            <div className="mr-2">
              <span className="font-pt max-lg:text-23 text-32 font-bold">
          ...
          <h2
            className="font-pt max-lg:text-23 text-32 mb-0 mt-px flex font-bold"
            style={{
              color: isCool ? 'var(--brand-cool-dark-text)' : 'var(--brand-warm-dark-text)',
            }}
          >
