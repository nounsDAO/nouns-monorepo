      ...
      <>
        ...
        <div className="flex justify-center">
          ...
          {withdrawTokensState.status === 'Success' && (
            <div className="font-pt mb-8 text-center text-[18px] font-bold">
              <p>
                <Trans>
  ...
  return (
    <>
      ...
      <div className="flex justify-end">
        ...
        {/* Hover brightness */}
        <div
          className="absolute right-10 top-[68%] cursor-pointer text-[18px] font-bold"
          onClick={() =>
            setWithdrawAmount(
              parseFloat(
                isUSDC
      ...
      />
      <div className="my-4 flex justify-center font-bold opacity-50">
