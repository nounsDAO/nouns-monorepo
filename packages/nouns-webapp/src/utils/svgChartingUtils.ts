...
const controlPoint =
  (line: (arg0: any, arg1: any) => any, smooth: number) =>
  (current: number[], previous: any, next: any, reverse: any) => {
...
const bezierCommand =
  (controlPoint: (arg0: any, arg1: any, arg2: any, arg3: boolean | undefined) => any) =>
  (point: any[], i: number, a: string | any[]) => {
...
const svgPath = (points: any[], command: (arg0: any, arg1: any, arg2: any) => any, h: any) => {
  const d = points.reduce(
    (acc: any, e: any[], i: number, a: string | any[]) =>
      i === 0
