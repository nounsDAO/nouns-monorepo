/*eslint-disable*/ module.exports = {
  messages: {
    ...
    '. Nouns can vote on proposals or delegate their vote to a third party. A minimum of':
      '. Ńōũńś ćàń vōţē ōń ƥŕōƥōśàĺś ōŕ ďēĺēĝàţē ţĥēĩŕ vōţē ţō à ţĥĩŕď ƥàŕţŷ. À mĩńĩmũm ōƒ',
    ...
    Against: 'Àĝàĩńśţ',
    'All Noun auction proceeds are sent to the': 'Àĺĺ Ńōũń àũćţĩōń ƥŕōćēēďś àŕē śēńţ ţō ţĥē',
    ...
    "For this reason, we, the project's founders (‘Nounders’) have chosen to compensate ourselves with Nouns. Every 10th Noun for the first 5 years of the project will be sent to our multisig (5/10), where it will be vested and distributed to individual Nounders.":
      "Ƒōŕ ţĥĩś ŕēàśōń, ŵē, ţĥē ƥŕōĴēćţ'ś ƒōũńďēŕś (‘Ńōũńďēŕś’) ĥàvē ćĥōśēń ţō ćōmƥēńśàţē ōũŕśēĺvēś ŵĩţĥ Ńōũńś. Ēvēŕŷ 10ţĥ Ńōũń ƒōŕ ţĥē ƒĩŕśţ 5 ŷēàŕś ōƒ ţĥē ƥŕōĴēćţ ŵĩĺĺ ƀē śēńţ ţō ōũŕ mũĺţĩśĩĝ (5/10), ŵĥēŕē ĩţ ŵĩĺĺ ƀē vēśţēď àńď ďĩśţŕĩƀũţēď ţō ĩńďĩvĩďũàĺ Ńōũńďēŕś.",
    Forums: 'Ƒōŕũmś',
    Function: 'Ƒũńćţĩōń',
    ...
    'Only Nouns you owned or were delegated to you before {0} are eligible to vote.': [
      'Ōńĺŷ Ńōũńś ŷōũ ōŵńēď ōŕ ŵēŕē ďēĺēĝàţēď ţō ŷōũ ƀēƒōŕē ',
      ['0'],
      ' àŕē ēĺĩĝĩƀĺē ţō vōţē.',
    ],
    Pending: 'Ƥēńďĩńĝ',
    ...
    h: 'ĥ',
    'heads (234)': 'ĥēàďś (234)',
    'is required to submit proposals.': 'ĩś ŕēǫũĩŕēď ţō śũƀmĩţ ƥŕōƥōśàĺś.',
    m: 'm',
    'or more': 'ōŕ mōŕē',
