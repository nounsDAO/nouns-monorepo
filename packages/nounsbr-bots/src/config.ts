...
export const config = {
  ...
  nounsbrSubgraph:
    process.env.NOUNSBR_SUBGRAPH_URL ??
    'https://api.thegraph.com/subgraphs/name/nounsbrdao/nounsbr-subgraph',
  ...
  nounsbrTokenAddress:
    process.env.NOUNSBR_TOKEN_ADDRESS ?? '0x9C8fF314C9Bc7F6e59A9d9225Fb22946427eDC03',
