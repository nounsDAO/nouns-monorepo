...
task('deploy-v2-logic', 'Deploys NounsBRDAOLogicV2').setAction(async (_args, { ethers, run }) => {
  const factory = await ethers.getContractFactory('NounsBRDAOLogicV2');
  ...
  console.log(`NounsBRDAOLogicV2 deployed to ${contract.address}`);
