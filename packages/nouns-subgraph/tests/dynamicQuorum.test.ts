...
test('dynamicQuorumVotes: quadratic, with both coefs', () => {
  ...
  assert.bigIntEquals(
    BigInt.fromI32(20),
    dynamicQuorumVotes(10, BigInt.fromI32(200), 1000, 4000, 500, linearCoef, quadraticCoef),
  );
  assert.bigIntEquals(
    BigInt.fromI32(28),
    dynamicQuorumVotes(20, BigInt.fromI32(200), 1000, 4000, 500, linearCoef, quadraticCoef),
  );
  assert.bigIntEquals(
    BigInt.fromI32(46),
    dynamicQuorumVotes(30, BigInt.fromI32(200), 1000, 4000, 500, linearCoef, quadraticCoef),
  );
  assert.bigIntEquals(
    BigInt.fromI32(74),
    dynamicQuorumVotes(40, BigInt.fromI32(200), 1000, 4000, 500, linearCoef, quadraticCoef),
  );
  assert.bigIntEquals(
    BigInt.fromI32(80),
    dynamicQuorumVotes(50, BigInt.fromI32(200), 1000, 4000, 500, linearCoef, quadraticCoef),
  );
  assert.bigIntEquals(
    BigInt.fromI32(80),
    dynamicQuorumVotes(80, BigInt.fromI32(200), 1000, 4000, 500, linearCoef, quadraticCoef),
  );
});
...
test('dynamicQuorumVotes: capped at max', () => {
  ...
  assert.bigIntEquals(
    BigInt.fromI32(112),
    dynamicQuorumVotes(50, BigInt.fromI32(200), 1000, 10000, 500, linearCoef, quadraticCoef),
  );
});
