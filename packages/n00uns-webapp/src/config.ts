...
const app: Record<SupportedChains, AppConfig> = {
  [ChainId.Rinkeby]: {
    ...
    subgraphApiUri: 'https://api.thegraph.com/subgraphs/name/n00unsdao/n00uns-subgraph-rinkeby-v5',
  ...
  [ChainId.Mainnet]: {
    ...
    subgraphApiUri: 'https://api.thegraph.com/subgraphs/name/n00unsdao/n00uns-subgraph',
    enableHistory: process.env.REACT_APP_ENABLE_HISTORY === 'true',
  },
  [ChainId.Polygon]: {
    jsonRpcUri: createNetworkHttpUrl('polygon-mainnet'),
    wsRpcUri: createNetworkWsUrl('polygon-mainnet'),
    subgraphApiUri: 'https://api.thegraph.com/subgraphs/name/yanuar-ar/n00uns',
    enableHistory: process.env.REACT_APP_ENABLE_HISTORY === 'true',
  },
  [ChainId.Mumbai]: {
  ...
  [ChainId.Hardhat]: {
    ...
    subgraphApiUri: 'http://localhost:8000/subgraphs/name/n00unsdao/n00uns-subgraph',
    enableHistory: process.env.REACT_APP_ENABLE_HISTORY === 'true',
  },
};
...
const getAddresses = (): ContractAddresses => {
  let n00unsAddresses = {} as N00unsContractAddresses;
  try {
    n00unsAddresses = getContractAddressesForChainOrThrow(CHAIN_ID);
  } catch {}
  return { ...n00unsAddresses, ...externalAddresses[CHAIN_ID] };
};
