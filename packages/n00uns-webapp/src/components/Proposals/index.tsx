import { PartialProposal, ProposalState, useProposalThreshold } from '../../wrappers/n00unsDao';
...
import { useUserN00unTokenBalance, useUserVotes } from '../../wrappers/n00unToken';
