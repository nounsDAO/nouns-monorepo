...
const NavBar = () => {
  ...
  const daoEtherscanLink = buildEtherscanHoldingsLink(config.addresses.n00unsDaoExecutor);
      ...
      >
        <Container style={{ maxWidth: 'unset' }}>
            ...
            <Nav.Item>
              {treasuryBalance && (
                <Nav.Link
                  ...
                  className={classes.n00unsNavLink}
                  target="_blank"
                  rel="noreferrer"
                >
                  <NavBarTreasury
          ...
          <Navbar.Collapse className="justify-content-end">
            <Nav.Link as={Link} to="/vote" className={classes.n00unsNavLink} onClick={closeNav}>
              <NavBarButton
            ...
            <Nav.Link
              href={externalURL(ExternalURL.n00unsCenter)}
              className={classes.n00unsNavLink}
              target="_blank"
              rel="noreferrer"
              onClick={closeNav}
            ...
            <div className={clsx(responsiveUiUtilsClasses.mobileOnly)}>
              ...
              <Nav.Link
                as={Link}
                to="/explore"
                className={clsx(classes.n00unsNavLink, classes.exploreButton)}
                onClick={closeNav}
              >
                <NavBarButton
