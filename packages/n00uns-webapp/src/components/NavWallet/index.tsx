...
const NavWallet: React.FC<NavWalletProps> = props => {
  ...
  const walletConnectedContentMobile = (
    <div className={clsx(navDropdownClasses.n00unsNavLink, responsiveUiUtilsClasses.mobileOnly)}>
      <div
  ...
  const walletConnectedContentDesktop = (
    <Dropdown
      className={clsx(navDropdownClasses.n00unsNavLink, responsiveUiUtilsClasses.desktopOnly)}
  ...
  return (
    <>
      ...
      {activeAccount ? (
        ...
        <WalletConnectButton
          className={clsx(navDropdownClasses.n00unsNavLink, navDropdownClasses.connectBtn)}
