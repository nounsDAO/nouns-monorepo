...
import { ImageData, getN00unData, getRandomN00unSeed } from '@n00uns/assets';
import { buildSVG, EncodedImage, PNGCollectionEncoder } from '@n00uns/sdk';
...
const n00unsAssetsLink = (
  <Link
    text="n00uns-assets"
    url="https://github.com/n00unsDAO/n00uns-monorepo/tree/master/packages/n00uns-assets"
    leavesPage={true}
  />
);
...
const n00unsSDKLink = (
  <Link
    text="n00uns-sdk"
    url="https://github.com/n00unsDAO/n00uns-monorepo/tree/master/packages/n00uns-sdk"
    leavesPage={true}
  />
);
      ...
      <Container fluid="lg">
        <Row>
          <Col lg={10} className={classes.headerRow}>
            ...
            <p>
              <Trans>
                The playground was built using the {n00unsProtocolLink}. N00un's traits are
                determined by the N00un Seed. The seed was generated using {n00unsAssetsLink} and
                rendered using the {n00unsSDKLink}.
              </Trans>
            </p>
          </Col>
        </Row>
