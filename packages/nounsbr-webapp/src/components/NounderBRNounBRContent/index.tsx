...
import nounbrContentClasses from './NounderBRNounBRContent.module.css';
...
const NounderBRNounBRContent: React.FC<{
        ...
        <Row className={auctionActivityClasses.activityRow}>
          ...
          >
            <div className={auctionActivityClasses.section}>
              <Winner winner={''} isNoundersBR={true} />
            </div>
          </Col>
        </Row>
      </div>
...
export default NounderBRNounBRContent;
