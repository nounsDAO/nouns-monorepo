...
const encode = async () => {
  ...
  const partfolders = ['1-types', '2-necks', '3-cheekses', '4-faces', '5-beards', '6-mouths', '7-earses', '8-hats', '9-hairs', '10-teeths', '11-lipses', '12-emotions', '13-eyeses', '14-glasseses', '15-noses'];
