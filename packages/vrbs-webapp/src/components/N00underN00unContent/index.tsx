...
import n00unContentClasses from './N00underN00unContent.module.css';
...
const N00underN00unContent: React.FC<{
    ...
    <AuctionActivityWrapper>
      <div className={auctionActivityClasses.informationRow}>
        <Row className={auctionActivityClasses.activityRow}>
          ...
          <Col lg={12}>
            <AuctionActivityN00unTitle n00unId={n00unId} />
          </Col>
        </Row>
        <Row className={auctionActivityClasses.activityRow}>
          ...
          <Col
            lg={5}
            className={`${auctionActivityClasses.currentBidCol} ${n00unContentClasses.currentBidCol} ${auctionActivityClasses.auctionTimerCol}`}
          >
            <div className={auctionActivityClasses.section}>
              <Winner winner={''} isN00unders={true} />
            </div>
          </Col>
        </Row>
      </div>
          ...
          <ul className={auctionBidClasses.bidCollection}>
            <li
              className={
                ...
                ` ${n00unContentClasses.bidRow}`
              }
            >
              <Trans>All N00un auction proceeds are sent to the</Trans>{' '}
              <Link to="/vote" className={n00unContentClasses.link}>
                <Trans>N00uns DAO</Trans>
              </Link>
              .{' '}
              <Trans>
                For this reason, we, the project's founders (‘N00unders’) have chosen to compensate
                ourselves with N00uns. Every 10th N00un for the first 5 years of the project will be
...
export default N00underN00unContent;
