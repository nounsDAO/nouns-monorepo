...
import { Proposal, useHasVotedOnProposal, useProposalVote } from '../../wrappers/vrbsDao';
import clsx from 'clsx';
import { isMobileScreen } from '../../utils/isMobile';
import { useUserVotesAsOfBlock } from '../../wrappers/vrbsToken';
  ...
  return (
    <>
      ...
      {proposal && isActiveForVoting && proposalCreationTimestamp && !!availableVotes && !hasVoted && (
        <Alert variant="success" className={classes.voterIneligibleAlert}>
          <Trans>
            Only N00uns you owned or were delegated to you before{' '}
