...
export interface N00unsTransitionProps {
 ...
 * @param props  N00unsTransitionProps
 */
const N00unsTransition: React.FC<N00unsTransitionProps> = props => {
  const {
    children = <></>,
    nodeRef,
    show,
...
export default N00unsTransition;
