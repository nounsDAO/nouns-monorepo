...
export interface VrbsTransitionProps {
 ...
 * @param props  VrbsTransitionProps
 */
const VrbsTransition: React.FC<VrbsTransitionProps> = props => {
  const {
    children = <></>,
    nodeRef,
    show,
