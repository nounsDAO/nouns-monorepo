...
const NavWallet: React.FC<NavWalletProps> = props => {
  ...
  const walletConnectedContentMobile = (
    <div className={clsx(navDropdownClasses.vrbsNavLink, responsiveUiUtilsClasses.mobileOnly)}>
      <div
  ...
  const walletConnectedContentDesktop = (
    <Dropdown
      className={clsx(navDropdownClasses.vrbsNavLink, responsiveUiUtilsClasses.desktopOnly)}
  ...
  return (
    <>
      ...
      {activeAccount ? (
        ...
        <WalletConnectButton
          className={clsx(navDropdownClasses.vrbsNavLink, navDropdownClasses.connectBtn)}
