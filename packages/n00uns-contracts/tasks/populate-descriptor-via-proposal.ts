...
task(
  ...
  .addParam('n00unsDescriptor', 'The `N00unsDescriptor` contract address')
  ...
  .setAction(
    async ({ n00unsDescriptor, daoAddress, imageDataPath, proposalTextPath }, { ethers }) => {
