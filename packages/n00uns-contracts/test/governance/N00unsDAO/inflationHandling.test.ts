...
import { N00unsToken, N00unsDAOLogicV1 } from '../../../typechain';
...
describe('N00unsDAO#inflationHandling', () => {
  before(async () => {
  ...
  it('returns quorum votes and proposal threshold based on N00un total supply', async () => {
    // Total Supply = 40
  ...
  it('rejects if proposing below threshold', async () => {
    ...
    ).revertedWith('N00unsDAO::propose: proposer votes below proposal threshold');
  });
