...
task('deploy-v2-logic', 'Deploys N00unsDAOLogicV2').setAction(async (_args, { ethers, run }) => {
  const factory = await ethers.getContractFactory('N00unsDAOLogicV2');
  ...
  console.log(`N00unsDAOLogicV2 deployed to ${contract.address}`);
