...
task('deploy-v2-logic', 'Deploys DAOLogicV2').setAction(async (_args, { ethers, run }) => {
  const factory = await ethers.getContractFactory('DAOLogicV2');
  ...
  console.log(`DAOLogicV2 deployed to ${contract.address}`);
