    ...
    OwnableUpgradeable
{
 ...
 IERC20 public biddingToken;
    ...
    function _createAuction() internal {
        try vrbs.mint() returns (uint256 n00unId) {
    ...
    function _settleAuction() internal {
        ...
        if (_auction.bidder == address(0)) {
            vrbs.burn(_auction.n00unId);
        } else {
            vrbs.transferFrom(address(this), _auction.bidder, _auction.n00unId);
        }
