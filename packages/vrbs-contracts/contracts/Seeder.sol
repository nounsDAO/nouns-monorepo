...
/// @title The VrbsToken pseudo-random seed generator
...
contract Seeder is ISeeder {
    /**
     * @notice Generate a pseudo-random vrb seed using the previous blockhash and vrb ID.
     */
    // prettier-ignore
    function generateSeed(uint256 vrbId, IDescriptorMinimal descriptor) external view override returns (Seed memory) {
