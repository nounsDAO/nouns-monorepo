...
/// @title The Vrbs DAO executor and treasury
...
// This contract acts as executor of Vrbs DAO governance and its treasury, so it has been modified to accept ETH.
...
contract DAOExecutor {
    ...
    constructor(address admin_, uint256 delay_) {
        require(delay_ >= MINIMUM_DELAY, 'DAOExecutor::constructor: Delay must exceed minimum delay.');
