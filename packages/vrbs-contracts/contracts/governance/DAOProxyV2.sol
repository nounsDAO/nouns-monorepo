...
/// @title The Vrbs DAO proxy contract for V2
...
// DAOProxyV2.sol is a modified version of DAOProxy.sol, tailored for the DAO's V2.
...
contract DAOProxyV2 is DAOStorageV2, DAOEvents {
    constructor(
        address timelock_,
        address vrbs_,
        address vetoer_,
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'DAOProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'DAOProxy::_setImplementation: invalid implementation address');
