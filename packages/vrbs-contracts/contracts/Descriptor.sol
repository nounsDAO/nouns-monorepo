...
contract Descriptor is IDescriptor, Ownable {
    ...
    // Whether or not new Vrb parts can be added
    ...
    // Vrb Color Palettes (Index => Hex Colors)
    mapping(uint8 => string[]) public override palettes;

    // Vrb Backgrounds (Hex Colors)
    string[] public override backgrounds;

    // Vrb Bodies (Custom RLE)
    bytes[] public override bodies;

    // Vrb Accessories (Custom RLE)
    bytes[] public override accessories;

    // Vrb Heads (Custom RLE)
    bytes[] public override heads;

    // Vrb Glasses (Custom RLE)
    ...
    /**
     * @notice Get the number of available Vrb `backgrounds`.
     */
    ...
    /**
     * @notice Get the number of available Vrb `bodies`.
     */
    ...
    /**
     * @notice Get the number of available Vrb `accessories`.
     */
    ...
    /**
     * @notice Get the number of available Vrb `heads`.
     */
    ...
    /**
     * @notice Get the number of available Vrb `glasses`.
     */
    ...
    /**
     * @notice Batch add Vrb backgrounds.
    ...
    /**
     * @notice Batch add Vrb accessories.
     * @dev This function can only be called by the owner when not locked.
     */
    ...
    /**
     * @notice Given a token ID and seed, construct a token URI for an official Vrbs DAO vrb.
    ...
    /**
     * @notice Given a token ID and seed, construct a base64 encoded data URI for an official Vrbs DAO vrb.
     */
    function dataURI(uint256 tokenId, ISeeder.Seed memory seed) public view override returns (string memory) {
        string memory vrbId = tokenId.toString();
        string memory name = string(abi.encodePacked('Vrb ', vrbId));
        string memory description = string(abi.encodePacked('Vrb ', vrbId, ' is a member of the Vrbs DAO'));
    ...
    /**
     * @notice Get all Vrb parts for the passed `seed`.
     */
