...
contract DescriptorV2 is IDescriptorV2, Ownable {
    ...
    /// @notice The contract responsible for holding compressed Vrb art
    IArt public art;

    /// @notice The contract responsible for constructing SVGs
    ISVGRenderer public renderer;

    /// @notice Whether or not new Vrb parts can be added
    ...
    /**
     * @notice Set the Vrb's art contract.
