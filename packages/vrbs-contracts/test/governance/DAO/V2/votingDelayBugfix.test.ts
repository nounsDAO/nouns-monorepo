...
let govV1: DAOLogicV1;
let govV2: DAOLogicV2;
...
describe('VrbsDAOV2 votingDelay bugfix', () => {
  before(async () => {
    ...
    govV1 = DaoLogicV1Factory.connect(govProxyAddress, deployer);
    govV2 = DaoLogicV2Factory.connect(govProxyAddress, deployer);
  });
